...
geography_encoder = onehot_geography.transform([[geography]]).toarray()
...
# Ensure all geography columns from training are present
...
# Scale the input data (now includes encoded Geography)
